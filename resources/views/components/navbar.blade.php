<nav {{ $attributes->merge(['class' => 'border-gray-200 px-2 sm:px-4 py-2.5']) }}>
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="#" class="flex items-center">
      <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">WolfieWorks</span>
    </a>
